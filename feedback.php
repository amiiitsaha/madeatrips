            ...
            <div class="col-lg-6 col-sm-12 shadow mt-4 p-3 seventh">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="name" class="fifth" id="name" name="name" style="width:100%">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" class="fifth" id="email" name="email" style="width:100%">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="contact">Contact Number</label>
                        <input type="text" class="fifth" id="contact" name="contact" style="width:100%">
                        <span class="text-danger small">optional</span>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="feed">Enter your Feedback</label>
                        <textarea class="fifth" id="feed" name="feed" style="width:100%"></textarea>
